...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 80efd94a-4146-41ef-9f44-0299bea79dcf
```

> `80efd94a-4146-41ef-9f44-0299bea79dcf` is the password of the certificate, you can change it to any password you want.
