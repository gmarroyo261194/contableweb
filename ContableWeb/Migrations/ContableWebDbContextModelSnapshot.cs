...
{
    [DbContext(typeof(ContableWebDbContext))]
    partial class ContableWebDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ContableWeb.Entities.Afip.AfipTokenEntity", b =>
                {
                    ...
                    b.ToTable("AfipTokens");
                });

            modelBuilder.Entity("ContableWeb.Entities.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("ContableWeb.Entities.Clientes.Cliente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ContableWeb.Entities.Rubros.Rubro", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppRubros", (string)null);
                });

            modelBuilder.Entity("ContableWeb.Entities.Servicios.Servicio", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppServicios", (string)null);
                });

            modelBuilder.Entity("ContableWeb.Entities.TiposComprobantes.TipoComprobante", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppTiposComprobantes", (string)null);
                });

            modelBuilder.Entity("ContableWeb.Entities.TiposCondicionesIva.TipoCondicionIva", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppTiposCondicionesIva", (string)null);
                });

            modelBuilder.Entity("ContableWeb.Entities.TiposDocumentos.TipoDocumento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppTiposDocumentos", (string)null);
                });
            ...
            modelBuilder.Entity("ContableWeb.Entities.Servicios.Servicio", b =>
                {
                    b.HasOne("ContableWeb.Entities.Rubros.Rubro", null)
                        .WithMany()
                        .HasForeignKey("RubroId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("ContableWeb.Entities.Rubros.Rubro", "Rubro")
                        .WithMany("Servicios")
