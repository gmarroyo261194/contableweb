...
public class ContableWebModule : AbpModule
{
    ...
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        PreConfigure<OpenIddictBuilder>(builder =>
        {
            ...
            {
                options.AddAudiences("ContableWeb");
    ...
    private void ConfigureRouter(ServiceConfigurationContext context)
    {
        ...
        {
            options.AppAssembly = typeof(ContableWebModule).Assembly;
        });
    }
    ...
    private void ConfigureLocalization()
    {
        ...
        {
            options.Resources
                .Add<ContableWebResource>("es")
                .AddBaseTypes(typeof(AbpValidationResource), typeof(AbpUiResource))
                .AddVirtualJson("/Localization/ContableWeb");

            options.DefaultResourceType = typeof(ContableWebResource);
        ...
        {
            options.MapCodeNamespace("ContableWeb", typeof(ContableWebResource));
        });
    }
    ...
    private void ConfigureAutoApiControllers()
    {
        ...
        {
            options.ConventionalControllers.Create(typeof(ContableWebModule).Assembly);
        });
    }
    ...
    private void ConfigureSwagger(IServiceCollection services)
    {
        services.AddAbpSwaggerGen(
            options =>
            {
                options.SwaggerDoc("v1", new OpenApiInfo { Title = "ContableWeb API", Version = "v1" });
    ...
    {
        context.Services.AddAutoMapperObjectMapper<ContableWebModule>();
        Configure<AbpAutoMapperOptions>(options =>
        {
             ...
             */
            options.AddMaps<ContableWebModule>(/* validate: true */);
        });
    }
    ...
    private void ConfigureVirtualFiles(IWebHostEnvironment hostingEnvironment)
    {
        ...
        {
            options.FileSets.AddEmbedded<ContableWebModule>();
            if (hostingEnvironment.IsDevelopment())
            {
                /* Using physical files in development, so we don't need to recompile on changes */
                options.FileSets.ReplaceEmbeddedByPhysical<ContableWebModule>(hostingEnvironment.ContentRootPath);
            }
        });
    }
    ...
    {
        context.Services.AddAbpDbContext<ContableWebDbContext>(options =>
        {
